...
const prev = document.querySelector('li.menu-list-left');
const next = document.querySelector('li.menu-list-right');
...
function changeButtonStyle() {
    if (temp) {
        ...
        temp.style.color = '#424242';
    }
    buttons[imgCount - 1].style.background = '#424242';
